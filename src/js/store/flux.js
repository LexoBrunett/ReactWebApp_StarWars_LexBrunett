...
// mi funcion para login
			login: async (email, password) => {
				try {
					let data = await axios.post("/login", {   //acá uno con el back
						"email": email,
						"password": password
...
// mi funcion para validar token
			validoToken: async () => {
				...
				try {
					let data = await axios.get("/valid_token", {   //acá uno con el back
...
//mi funcion para signup
			signup: async (email, password) => {
				try {
					let data = await axios.post("/signup", {   //acá uno con el back
						"email": email,
						"password": password
